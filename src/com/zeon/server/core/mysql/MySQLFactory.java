...
public class MySQLFactory{
    ...
    public JavaServerProperties properties;
    	...
    	public MySQLFactory() throws SQLException
	{
		...
		try
		{
			...
			DataSource unpooled = DataSources.unpooledDataSource(properties.getProperty("database.url")+"&"+properties.getProperty("database.cahrEncoding"), properties.getProperty("database.username"), properties.getProperty("database.password"));
