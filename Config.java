...
public final class Config 
{
    ...
    * diff = -8 (mob is 8 levels below), XP bonus rate = 0.4, SP bonus rate = 0.16 */
    ...
    /** Properties file for custom configuration */
    ...
    /** Enable TvT event ?*/
    public static boolean    TVT_EVENT_ENABLE;
    /** TvT maximum participants ?*/
    public static int        TVT_MAX_PARTICIPANTS;
    /** TvT minimum participants ?*/
    public static int        TVT_MIN_PARTICIPANTS;
    /** TvT event delay ?*/
    public static int        TVT_EVENT_DELAY;
    /** TvT event npc id ?*/
    public static int        TVT_NPC_MANAGER;
    /** TvT event NPC coord x ?*/
    public static int        TVT_NPC_X;
    /** TvT event NPC coord y ?*/
    public static int        TVT_NPC_Y;
    /** TvT event NPC coord z ?*/
    public static int        TVT_NPC_Z;
    /** TvT event participation time ?*/
    public static int        TVT_EVENT_PARTICIPATION_TIME;
    /** TvT event duration ?*/
    public static int        TVT_EVENT_DURATION;
    /** TvT event reward id ?*/
    public static int        TVT_REWARD;
    /** TvT event reward count ?*/
    public static int        TVT_REWARD_COUNT;
	...
	public static void load()
	{
	    ...
	    try
	    {
	        ...
	        is.close();
                ...
                TVT_EVENT_ENABLE             = Boolean.valueOf(customSettings.getProperty("TvTEventEnable", "false"));
                TVT_MAX_PARTICIPANTS         = Integer.parseInt(customSettings.getProperty("TvTMaxParticipants", "40"));
                TVT_MIN_PARTICIPANTS         = Integer.parseInt(customSettings.getProperty("TvTMinParticipants", "6"));
                TVT_EVENT_DELAY              = Integer.parseInt(customSettings.getProperty("TvTEventDelay", "18000000"));
                TVT_NPC_MANAGER              = Integer.parseInt(customSettings.getProperty("TvTNpcManager", "12371"));
                TVT_NPC_X                    = Integer.parseInt(customSettings.getProperty("TvTNpcX", "151808"));
                TVT_NPC_Y                    = Integer.parseInt(customSettings.getProperty("TvTNpcY", "46864"));
                TVT_NPC_Z                    = Integer.parseInt(customSettings.getProperty("TvTNpcZ", "-3408"));
                TVT_EVENT_PARTICIPATION_TIME = Integer.parseInt(customSettings.getProperty("TvTEventParticipationTime", "1200"));
                TVT_EVENT_DURATION           = Integer.parseInt(customSettings.getProperty("TvTEventDuration", "1800"));
                TVT_REWARD                   = Integer.parseInt(customSettings.getProperty("TvTEventReward", "57"));
                TVT_REWARD_COUNT             = Integer.parseInt(customSettings.getProperty("TvTEventRewardCount", "10000000"));
